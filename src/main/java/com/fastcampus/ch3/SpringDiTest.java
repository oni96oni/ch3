...
////        Car car = (Car) ac.getBean("car"); //byName. 이름으로 검색해서 찾아온것, 아래와 같은 문장!
//        Car car = ac.getBean("car", Car.class); //byName을 사용, 형변환 생략한 버전(타입정보를 주면 형변환 생략 가능)
////        Car car2 = (Car) ac.getBean(Car.class); //byType을 사용해서 빈을 찾아가지고 온것
